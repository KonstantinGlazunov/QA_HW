...
public class PracticeFormTests extends TestBase {
    ...
    public void fillStudentFormTest() {
        //enter personal data //select Gender  //Enter Date  //select subjects
        //select hobby  // upload file // enter address //chooce stat city
        //click on submit
        new PracticeFormPage(driver).enterPersonalData(StudentData.FIRST_NAME,
                ...
                // .enterDate(StudentData.DATE) //а эта работатет
                 .selectDate("May", "2001", "15") // чет не работает
